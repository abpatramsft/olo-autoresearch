...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        expected = {
            ...
            "rejected": ("exp_0001", "NOT PROMOTED"),
            "retained": ("exp_0002", "RETAINED"),
            "approved": ("exp_0003", "APPROVED"),
        }
        ...
        assert no_script_page.locator('[data-experiment="approved"]').is_disabled()
    ...
    print("Landing page passed: links, assets, tree, keyboard, clipboard, five viewports, reduced motion, no JavaScript.")
